...
ibutton.1 <- read_csv("~/data/CONA/2016/iButton/A500000032322841.csv",
...
ibutton.2 <- read_csv("~/data/CONA/2016/iButton/B00000026F9E41.csv",
                      col_types = cols(Unit = col_skip()),
                      skip = 19)
...
AnomalyDetectionTs(ibutton.5min[,c('date','T.1')],
                    max_anoms = 0.3,
                    plot = TRUE,
                    title = 'IButton 1',
                    alpha = 0.3,
...
AnomalyDetectionTs(ibutton.5min[,c('date','T.2')],
                    max_anoms = 0.3,
                    plot = TRUE,
                    title = 'IButton 2',
                    alpha = 0.3,
