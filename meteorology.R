...
rangiora.1_1 <- read.csv("~/data/CONA/from_work/MET/rangiora 1_1.csv")
rangiora.2_1 <- read.csv("~/data/CONA/from_work/MET/rangiora 2_1.csv")
rangiora.3_1 <- read.csv("~/data/CONA/from_work/MET/rangiora 3_1.csv")
