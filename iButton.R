...
iB_1B000000322E6141$date <- as.POSIXct(iB_1B000000322E6141$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
...
iB_3D00000026EEC341$date <- as.POSIXct(iB_3D00000026EEC341$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
...
iB_8800000026F06241$date <- as.POSIXct(iB_8800000026F06241$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
...
iB_A500000032322841$date <- as.POSIXct(iB_A500000032322841$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
...
iB_C200000026F9BE41$date <- as.POSIXct(iB_C200000026F9BE41$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
...
iB_D200000026F1EE41$date <- as.POSIXct(iB_D200000026F1EE41$Date.Time,format = '%d/%m/%y %I:%M:%S %p')
