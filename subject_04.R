...
timePlot(plot_data,pollutant = c('Temp.191','PM_mV','PM10.FDMS'),avg.time = '1 hour')
timePlot(plot_data,pollutant = c('Temp.191','PM_mV','PM10.FDMS'),avg.time = '1 day')
timePlot(plot_data,pollutant = c('Temp.191','PM_mV','PM10.FDMS'),avg.time = '1 hour', statistic = 'max')
